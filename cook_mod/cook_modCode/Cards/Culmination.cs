...
public class Culmination() : CustomCardModel(0, CardType.Attack,
    CardRarity.Uncommon, TargetType.AnyEnemy)
{
    public sealed override string CustomPortraitPath => "res://cook_mod/culmination.png";
    ...
    {
        if (this.IsUpgraded)
            await FlavorCmd.AddRandomGenericFlavor(choiceContext, this.Owner, this, 1);
