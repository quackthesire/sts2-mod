    ...
    CardRarity.Uncommon, TargetType.Self)
{
    ...
    {
        await PowerCmd.Apply<FurnishmentPower>(choiceContext, this.Owner.Creature, this.DynamicVars["FurnishmentPower"].BaseValue, this.Owner.Creature, this);
    }
    
    protected override void OnUpgrade()
    {
        this.DynamicVars["FurnishmentPower"].UpgradeValueBy(1m);
    }
}