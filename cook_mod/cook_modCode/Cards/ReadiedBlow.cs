...
public class ReadiedBlow() : CustomCardModel(4, CardType.Attack,
    CardRarity.Uncommon, TargetType.AnyEnemy)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await DamageCmd.Attack(base.DynamicVars.Damage.BaseValue).FromCard((CardModel) this).WithHitCount(base.DynamicVars.Repeat.IntValue).Targeting(cardPlay.Target).WithHitFx("vfx/vfx_dramatic_stab", null, "blunt_attack.mp3").Execute(choiceContext);
    }
