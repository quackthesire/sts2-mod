...
public class RuthlessBlades() : CustomCardModel(1, CardType.Skill,
    CardRarity.Uncommon, TargetType.Self)
{
    ...
    {
        await CreateCard.GiveCards<Knife>(Owner, base.DynamicVars["Knives"].IntValue, PileType.Hand, upgraded: Upgrade());
    }
