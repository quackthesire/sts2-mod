...
public class SadisticNature() : CustomCardModel(1, CardType.Power,
    CardRarity.Uncommon, TargetType.Self)
{
    ...
    {
        await PowerCmd.Apply<SadisticNaturePower>(choiceContext, base.Owner.Creature, base.DynamicVars.Block.BaseValue, base.Owner.Creature, this);
    }
