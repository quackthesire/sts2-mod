...
public class ScrapMetal() : CustomCardModel(0, CardType.Skill,
    CardRarity.Uncommon, TargetType.Self), IOnPrepared
{
    ...
    {
        await PrepareCmd.Exhaust(choiceContext, base.Owner, base.DynamicVars.Cards.IntValue, 0, base.DynamicVars.Cards.IntValue, cardPlay);
    }
