    ...
    CardRarity.Common, TargetType.Self)
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new BlockVar(13m, ValueProp.Move), new PowerVar<FrailPower>(2m)];

    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        await CreatureCmd.GainBlock(this.Owner.Creature, this.DynamicVars.Block, cardPlay);
        await PowerCmd.Apply<FrailPower>(choiceContext, this.Owner.Creature, this.DynamicVars["FrailPower"].BaseValue, this.Owner.Creature, (CardModel) this);
    }
