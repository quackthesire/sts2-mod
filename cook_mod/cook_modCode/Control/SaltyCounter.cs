...
public partial class SaltyCounter : Godot.Control
{
    public static Label _label;
    public static Godot.Control _control;
    public static TextureRect _texRect;

    public static AddedNode<NEnergyCounter, SaltyCounter> Node = new((energy) =>
    {
        //would probably suggest loading from scene rather than this manual setup
        var control = new SaltyCounter();
        
        var tex = ResourceLoader.Load<Texture2D>("res://cook_mod/salty.png");
