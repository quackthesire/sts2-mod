...
{
    public sealed override string CustomPortraitPath => "res://cook_mod/cranberry.png";
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<WeakPower>(2m), new ExhaustiveVar(3m)];
