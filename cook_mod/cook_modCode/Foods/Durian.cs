    ...
    CardRarity.Token, TargetType.Self, sweet: 2, bitter: 2)
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPower<Prepare>(), HoverTipFactory.FromPower<Sweet>(), HoverTipFactory.FromPower<Bitter>()];
